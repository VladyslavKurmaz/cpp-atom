...
static atom::po::id_t const po_hk_terminate			=	po_hk_ctrl_c + 1;
static atom::po::id_t const po_hk_close				=	po_hk_terminate + 1;
...
static WORD	const CMDID_TERMINATE	= CMDID_CTRL_C + 1;
static WORD	const CMDID_CLOSE		= CMDID_TERMINATE + 1;
