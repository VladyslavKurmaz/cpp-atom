...
#	define ATOM_DBG_MARK_END( _1, _2, _3 )	} _CrtMemState _2, _3; _CrtMemCheckpoint( &_2 ); if ( _CrtMemDifference( &_3, &_1, &_2 ) ) { _CrtMemDumpStatistics( &_3 ); _CrtDumpMemoryLeaks(); assert( false ); }
#endif
