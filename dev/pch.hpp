...
#define LOGGER_ACCESSOR( t )  logger_ptr getLogger() { return ( ( get_value( boost::mpl::identity< t >() ).item() ) ); }
	...
	typedef std::list< comp_ptr > comps_t;
	...
	typedef atom::nstorage< comp, boost::shared_ptr, atom::narray1 > appl2comp;
	// comp
	typedef atom::nstorage< logger, boost::shared_ptr, atom::narray1 > comp2logger;
	typedef atom::nstorage< comp, boost::shared_ptr, atom::narray1 > comp2comp;
	typedef atom::nstorage< comp, boost::shared_ptr, atom::nlist > comp2comps;
	//context
	...
	static std::string const  CONST_CMD_CHANGE_COMP = "cd";
